...
class Jieba {
 public:
  Jieba(bool fromShm,const string& dict_path,
        const string& model_path,
        const string& user_dict_path, 
        const string& idfPath, 
        const string& stopWordPath) 
    : dict_trie_(fromShm,dict_path, user_dict_path),
      model_(model_path),
      mp_seg_(&dict_trie_),
      hmm_seg_(&model_),
  ...
  bool isOK() {
	  return dict_trie_.static_node_infos_s != nullptr && dict_trie_.static_node_infos_s->size() > 0;
  }
